...
public class CustomerServiceVertxEBProxy implements CustomerService {
  private Vertx _vertx;
  private String _address;
  private DeliveryOptions _options;
  private boolean closed;

  public CustomerServiceVertxEBProxy(Vertx vertx, String address) {
    this(vertx, address, null);
  }

  public CustomerServiceVertxEBProxy(Vertx vertx, String address, DeliveryOptions options) {
    this._vertx = vertx;
  ...
  public void getCustomers(Handler<AsyncResult<JsonObject>> handler){
    ...
    _deliveryOptions.addHeader("action", "getCustomers");
