...
set CLASSPATH=%APP_HOME%\lib\reactive-hibernate-starter-1.0.0-SNAPSHOT-fat.jar

@rem Execute reactive-hibernate-starter
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %REACTIVE_HIBERNATE_STARTER_OPTS%  -jar "%CLASSPATH%" %CMD_LINE_ARGS%
